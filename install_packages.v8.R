...
install.github <- function(package, version, bioconductor_version, source = "bioc"){ # Suppose it's already downloaded (for safety)
  main_url <- paste0("/",package,"_",version,".tar.gz")
...
install.cran("reticulate", version="1.41.0.1")
...
itertools
remotes::install_github("mojaveazure/loomR") # 0.2.0
install.bioconductor("loomR", version="0.2.1.9000", "3.20")

remotes::install_github('tallulandrews/M3Drop')
install.bioconductor("M3Drop", version="3.10.6", "3.20")
