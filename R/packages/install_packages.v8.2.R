# Latest version made in June 2026
...
install.cran("withr", version="3.0.2") #OK
...
install.cran("xfun", version="0.58") #UPDATED
...
install.cran("tinytex", version="0.59") #UPDATED
...
install.cran("pkgload", version="1.5.2") #UPDATED
install.cran("pkgdown", version="2.2.0") #UPDATED
install.cran("Rcpp", version="1.1.1-1.1") #UPDATED
install.cran("RcppArmadillo", version="15.2.7-1") #UPDATED
...
install.cran("Hmisc", version="5.2-5") #UPDATED
...
install.cran("shiny", version="1.13.0") #UPDATED
...
install.cran("RSQLite", version="3.53.1") #UPDATED
...
install.cran("harmony", version="1.2.3") #OK # Archived
...
install.cran("listenv", version="0.10.1") #UPDATED
...
install.cran("enrichit", version="0.1.4") #OK # Dependency of clusterProfiler
