...
public class FileFilter 
{
	...
	public static void filterCells()
    {
		...
		// Process Main Matrix
		LoomFile.copyFloatMatrixByGene("/matrix", loom, "/matrix", loomNew, cellIndexesToFilter, data); // data should be updated
	...
	private static void filterGenes(LoomFile loom, HashSet<Long> geneIndexesToFilter)
    {
		...
		// Process Main Matrix
		LoomFile.copyFloatMatrixByCell("/matrix", loom, "/matrix", loomNew, geneIndexesToFilter, data); // data should be updated
