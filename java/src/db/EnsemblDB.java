...
public class EnsemblDB 
{
	...
	public static boolean isMito(String chr)
	{
		if(chr.equals("MT")) return true;
		if(chr.equals("mt")) return true;
		if(chr.equals("M")) return true;
		if(chr.equals("mitochondrion_genome")) return true;
		if(chr.equals("dmel_mitochondrion_genome")) return true;
		return false;
	}
	
	public static boolean isProteinCoding(String biotype)
	{
		if(biotype.equals("protein_coding")) return true;
		return false;
	}
	
	public static boolean isRibo(String biotype)
	{
		if(biotype.equals("rRNA")) return true;
		if(biotype.equals("ribosomal_genome")) return true;
		return false;
	}
