...
int main(int argc, char** argv) {
  ...
  ifstream fin(input_filepath.c_str());
  ...
  if (mode == "de_results"){
    ...
    ofstream fout_down(filtered_down.c_str());
    ofstream fout_up(filtered_up.c_str());
    ...
    ofstream fout(filtered_path.c_str());
  ...
  filtered_stats << run_id + "\t" << vec_down.size() << "\t" << vec_up.size() << "\n"; 
